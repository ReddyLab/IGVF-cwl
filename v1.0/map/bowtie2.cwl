...
inputs:
  ...
  omit-sec-seq:
    ...
    inputBinding:
      position: 1
      prefix: --omit-sec-seq
    doc: '    put ''*'' in SEQ and QUAL fields for secondary alignments. Performance: '
  seed:
    type: int?
    inputBinding:
      position: 1
  ...
  no-1mm-upfront:
    ...
    doc: '  do not allow 1 mismatch alignments before attempting to scan for the optimal
      seeded alignments '
  ignore-quals:
    type: boolean?
    inputBinding:
  ...
  al-conc:
    ...
    doc: '<path>      write pairs that aligned concordantly at least once to <path>
      (Note: for --un, --al, --un-conc, or --al-conc, add ''-gz'' to the option name,
      e.g. '
  met:
    type: int?
    inputBinding:
  ...
  ma:
    ...
    inputBinding:
      ...
      prefix: --ma
    doc: |
      <int>         match bonus (0 for --end-to-end, 2 for --local) 
  gbar:
    type: int?
    inputBinding:
      position: 1
  ...
  no-overlap:
    ...
    inputBinding:
      position: 1
      prefix: --no-overlap
    doc: '      not concordant when mates overlap at all Output: '
  k:
    type: int?
    inputBinding:
      position: 1
...
#   Alignment:
  very-fast:
    ...
    inputBinding:
      position: 1
      prefix: --very-fast
    doc: '      For --end-to-end: -D 5 -R 1 -N 0 -L 22 -i S,0,2.50; For --local: -D
  ...
  fast:
    ...
    inputBinding:
      position: 1
      prefix: --fast
    doc: '      For --end-to-end: -D 10 -R 2 -N 0 -L 22 -i S,0,2.50; For --local:
  ...
  sensitive:
    ...
    inputBinding:
      position: 1
      prefix: --sensitive
    doc: '      For --end-to-end: -D 15 -R 2 -N 0 -L 22 -i S,1,1.15; For --local:
  ...
  very-sensitive:
    ...
    doc: '      For --end-to-end: -D 20 -R 3 -N 0 -L 20 -i S,1,0.50; For --local:
  ...
  genome_ref_first_index_file:
    ...
    doc: First file (extension .1.bt2) of the Bowtie2 index files generated for the
      reference genome (see 
